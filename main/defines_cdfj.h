...
inline void setIncrement2(int fetcher, short increment) {
  _QINC[fetcher] = increment;
}
...
static unsigned int m_z  = 2342;
static unsigned int m_w = 122561;
...
// Copy memory from source to destinationı
// in theory 4x faster than myMemset(), but data must be WORD (4 byte) aligned

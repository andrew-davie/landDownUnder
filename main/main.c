...
const char (*Animate[TYPE_MAX])[] = {
    ...
    0,                          // 05 BOULDER_FALLING 
    0,                          // 06 STEELWALL       
    0,                          // 07 BOULDER         
    &AnimDogeCoin,              // 08 DOGE            
    0,                          // 09 EXPLODE_SPACE_0 
    0,                          // 10 EXPLODE_SPACE_1 
    0,                          // 11 EXPLODE_SPACE_2 
    0,                          // 12 EXPLODE_SPACE_3 
    0,                          // 13 EXPLODE_SPACE_4 
    0,                          // 14 EXPLODE_DOGE_0  
    0,                          // 15 EXPLODE_DOGE_1  
    0,                          // 16 EXPLODE_DOGE_2  
    0,                          // 17 EXPLODE_DOGE_3  
    0,                          // 18 EXPLODE_DOGE_4  
    0,                          // 19 ROCKFORD_PRE    
    &AnimRockford,              // 20 ROCKFORD        
    0,                          // 21 AMOEBA          
    &AnimDrip,                  // 22 DRIP            
    &AnimDripSplash,            // 23 DRIP_SPLASH     
    0,                          // 24 __NOTHING       
    0,                          // 25 EXPLODE_THIS    
    0,                          // 26 BLANK_THIS      
    0,                          // 27 DIRT3           
    0,                          // 28 DIRT2           
    0,                          // 29 EXPLODE_BLANK_0 
    0,                          // 30 EXPLODE_BLANK_1 
    0,                          // 31 EXPLODE_BLANK_2 
    0,                          // 32 EXPLODE_BLANK_3 
    0,                          // 33 EXPLODE_BLANK_4 
    0,                          // 34 DOGE_GRAB       
    0,                          // 35 DIRT_GRAB       
    0,                          // 36 DUST            
    0,                          // 37 DUST2           
    0,                          // 38 DUST3           
    &AnimBoulderShake,          // 39 BOULDER_SHAKE   
    0,                          // 40 DUST_LEFT       
    0,                          // 41 DUST2_LEFT      
    0,                          // 42 DUST3_LEFT      
    0,                          // 43 DUST_RIGHT      
